...
<body>
      ...
      <div>
        ...
        <div style="display: flex;line-height: 40px">
          ...
          <div class="moneys">
            <div class="box">
              <div>
                <input type="type" class="form-control" readonly name="money" value="50">
              </div>
              <div>
                <input type="type" class="form-control" readonly name="money" value="300">
              </div>

            </div>
            <div class="box">
              <div>
                <input type="type" class="form-control" readonly name="money" value="100">
              </div>
              <div>
                <input type="type" class="form-control" readonly name="money" value="500">
              </div>
            </div>
            <div class="box">
              <div>
                <input type="type" class="form-control" readonly name="money" value="200">
              </div>
        ...
        <div style="display: flex;line-height: 40px">
          ...
          <div style="display: flex;justify-content: space-between;width:200px">
            <div style="color: red;font-size: 30px;" class="sumprice">
              ...
              <input type="text" name="sumprice" id="" value="50" readonly style="border: 0px ;color: red;">
            </div>
          </div>
        </div>
  ...
  <script>
    ...
    let inputs = document.querySelectorAll('[name=money]')
