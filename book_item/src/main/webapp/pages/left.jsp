...
<head>
    ...
    <title>left</title>
    <link rel="stylesheet" href="/css/left.less">
        ...
        <div class="menu">
            ...
            <ul class="menu-links">
                ...
                <li class="nav-link" style="display: inline;">
                    <a href="/book/getBookAll?id=${user2.user_id}" target="con" style="height: 50px;" id="top_a"
                       class="first">
                ...
                <li class="nav-link" style="display: inline;">
                    ...
                    <div class="zi">
                        <a href="/user/toEdit?user_id=${user2.user_id}" target="con" style="height: 35px;">
                ...
                <c:if test="${user2.roles==1}">
                    ...
                    <li class="nav-link" style="display: inline;">
                        ...
                        <div class="zi">
                            <a href="/user/getAllUser" target="con" style="height: 35px;">
                    ...
                    <li class="nav-link" style="display: inline;">
                        <a href="#" style="height: 50px;" id="top_a">
                            ...
                            <svg id="imgs" width="16" height="16" fill="currentColor" class="bi bi-x-diamond-fill icon"
                                 viewBox="0 0 16 16">
                        ...
                        <div class="zi">
                            <a href="/classify/getClassifyAll" target="con" style="height: 35px;">
                    ...
                    <li class="nav-link" style="display: inline;">
                        <a href="#" style="height: 50px;" id="top_a">
                            <!-- <i class="iconfont icon-shouye icon"></i> -->
                            <svg id="imgs" width="16" height="16" fill="currentColor" class="bi bi-journal-text icon"
                                 viewBox="0 0 16 16">
                        ...
                        <div class="zi">
                            <a href="/book/getBookAllByManage" target="con" style="height: 35px;">
                    ...
                    <li class="nav-link" style="display: inline;">
                        <a href="#" style="height: 50px;" id="top_a">
                            <!-- <i class="iconfont icon-shouye icon"></i> -->
                            <svg id="imgs" width="16" height="16" fill="currentColor"
                                 class="bi bi-bookmark-check-fill icon"
                                 viewBox="0 0 16 16">
                                <path fill-rule="evenodd"
                        ...
                        <div class="zi">
                            <a href="/order/getAllOrder" target="con" style="height: 35px;">
...
<%--                <span>======用户left======</span>--%>
                ...
                <c:if test="${user2.roles!=1}">
                    ...
                    <li class="nav-link" style="display: inline;">
                        <a href="#" style="height: 50px;" id="top_a">
                            <!-- <i class="iconfont icon-shouye icon"></i> -->
                            <svg id="imgs" width="16" height="16" fill="currentColor" class="bi bi-geo-alt-fill icon"
                                 viewBox="0 0 16 16">
                        ...
                        <div class="zi">
                            <a href="/consignee/getAllConsignee?id=${user2.user_id}" target="con" style="height: 35px;">
                    ...
                    <li class="nav-link" style="display: inline;">
                        ...
                        <div class="zi">
                            <a href="/user/getAllOredrByUserName?name=${user2.name}&id=${user2.user_id}" target="con"
                               style="height: 35px;">
                                <span class="text nac-text" style="text-align: center;width: 100%;">--订单列表</span>
                            </a>
                            <a href="/ShopCart/getAllShopCart?id=${user2.user_id}" target="con" style="height: 35px;">
                    ...
                    <li class="nav-link" style="display: inline;">
                        <a href="/pages/user/userRecharge.jsp" target="con" style="height: 50px;" id="top_a"
                           class="last">
                            <!-- <i class="iconfont icon-shouye icon"></i> -->
                            <svg id="imgs" width="16" height="16" fill="currentColor"
                                 class="bi bi-currency-exchange icon"
                                 viewBox="0 0 16 16">
        ...
        <div class="bottom-content">
            <li class="">
                <a href="/user/quit">
                    <svg id="imgs" width="16" height="16" fill="currentColor" class="bi bi-box-arrow-left icon"
                         viewBox="0 0 16 16">
                        <path fill-rule="evenodd"
